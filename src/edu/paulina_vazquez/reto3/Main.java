...
public class Main {
    ...
    public static void main(String[] arg) {
        ...
        String significado [] = {"Combinación ordenada de ritmo, melodía y armonía.",
        ...
        DiccionarioDePalabras diccionarioDePalabras = new DiccionarioDePalabras(significado,palabras);
